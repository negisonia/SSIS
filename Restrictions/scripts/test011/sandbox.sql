...
SELECT common_create_step_custom_option(1,'Drug') INTO  step_custom_option_id_5;
...
--PERFORM  common_create_step_therapies(data_entry_2_id,NULL,TRUE,atomic_step_id_1);
...
--CREATE STEP NOTES
--PERFORM common_create_atomic_step_notes(data_entry_2_id,'ST',step_custom_option_id_5,  'Drug1 notes: notes for drug 1');
