...
SELECT hpt.id INTO health_plan_type_commercial FROM healthplantype hpt WHERE hpt.name='test_commercial' and hpt.isactive IS TRUE LIMIT 1;
SELECT hpt.id INTO health_plan_type_hix  FROM healthplantype hpt WHERE hpt.name='test_hix' and hpt.isactive IS TRUE LIMIT 1;


--CREATE PROVIDER
SELECT common_create_provider(TRUE,'provider_11',NULL) INTO provider_id;

--CREATE TIERS
SELECT common_create_tier(TRUE,'tier_1','tier_1') INTO tier_1;
SELECT common_create_tier(TRUE,'tier_2','tier_2') INTO tier_2;
SELECT common_create_tier(TRUE,'tier_3','tier_3') INTO tier_3;
SELECT common_create_tier(TRUE,'tier_3p','tier_3p') INTO tier_3p;
...
--FORMULARY 3
    ...
    --HEALTHPLAN
    PERFORM common_create_healthplan(health_plan_type_commercial,TRUE,'test_05_commercial_2',formularyId,provider_id);
...
--FORMULARY 7
    ...
    --HEALTHPLAN
    PERFORM common_create_healthplan(health_plan_type_commercial,TRUE,'test_05_commercial_3',formularyId,provider_id);
...
--FORMULARY 9
    ...
    --HEALTHPLAN
    PERFORM common_create_healthplan(health_plan_type_commercial,TRUE,'test_05_commercial_5',formularyId,provider_id);
...
--FORMULARY 10
    ...
    --HEALTHPLAN
    PERFORM common_create_healthplan(health_plan_type_commercial,FALSE,'test_05_commercial_6',formularyId,provider_id);
...
--FORMULARY 12
    ...
    --HEALTHPLAN
    PERFORM common_create_healthplan(health_plan_type_hix,TRUE,'test_05_hix_5',formularyId,provider_id);
