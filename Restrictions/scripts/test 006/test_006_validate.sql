...
--RETRIEVE DRUGS IDS
    ...
    SELECT d.id INTO drug_10 FROM ff.drugs d WHERE d.name='drug_10_inactive';
    SELECT d.id INTO drug_11 FROM ff.drugs d WHERE d.name='drug_11_inactive';

	--RETRIEVE HEALTH PLAN TYPES
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='commercial' INTO commercial_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='hix' INTO hix_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='commercial_bcbs' INTO commercial_bcbs_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='employer' INTO employer_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='medicare_ma' INTO medicare_ma_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='medicare_sn' INTO medicare_sn_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='medicare_pdp' INTO medicare_pdp_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='state_medicare' INTO state_medicare_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='dpp' INTO dpp_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='commercial_medicaid' INTO commercial_medicaid_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='union' INTO union_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='municipal_plan' INTO municipal_plan_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='pbm' INTO pbm_hpt_id;
    SELECT hpt.id FROM ff.health_plan_types hpt WHERE hpt.name='commercial_inactive' INTO commercial_inactive_hpt_id;

--RETRIEVE HEALTHPLANS IDS
SELECT hp.id INTO health_plan_commercial FROM ff.health_plans hp where hp.name='health_plan_comm';
SELECT hp.id INTO health_plan_hix FROM ff.health_plans hp where hp.name='health_plan_hix';
SELECT hp.id INTO health_plan_com_inactive FROM ff.health_plans hp where hp.name='health_plan_com_inactive';
...
--FORMULARY 1
SELECT EXISTS(SELECT 1 FROM dw.formulary_detail fd WHERE fd.health_plan_id=health_plan_commercial and fd.health_plan_name='health_plan_comm'
...
--FORMULARY 11
SELECT EXISTS(SELECT 1 FROM dw.formulary_detail fd WHERE fd.health_plan_id=health_plan_com_inactive and fd.health_plan_name='health_plan_com_inactive' and fd.drug_id=drug_1 and fd.tier_id=tier_1) INTO existsValue;
...
--FORMULARY 12
SELECT EXISTS(SELECT 1 FROM dw.formulary_detail fd WHERE fd.health_plan_id=health_plan_hix and fd.health_plan_name='health_plan_hix' and fd.drug_id=drug_11 and fd.tier_id=tier_2) INTO existsValue;
...
--FORMULARY 13
SELECT EXISTS(SELECT 1 FROM dw.formulary_detail fd WHERE fd.health_plan_id=health_plan_commercial and fd.health_plan_name='health_plan_comm' and fd.drug_id=drug_11 and fd.tier_id=tier_4) INTO existsValue;
