...
ELSE
    ...
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_commercial_1' and hp.provider_id=provider_1_id) INTO valueExists;
    IF valueExists IS FALSE THEN
        select throw_error('HEALTH PLAN : test_07_commercial_1  MISSING');
    END IF;

    --HEALTH PLAN HIX
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_hix_1' and hp.provider_id=provider_1_id) INTO valueExists;
    IF valueExists IS FALSE THEN
        select throw_error('HEALTH PLAN : test_hp_hix_1 MISSING');
    END IF;

    --HEALTH PLAN STATE
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_state_1' and hp.provider_id=provider_1_id) INTO valueExists;
    IF valueExists IS FALSE THEN
...
ELSE
     --HEALTH PLAN UNION
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_union_1' and hp.provider_id=provider_2_id) INTO valueExists;
    IF valueExists IS FALSE THEN
...
ELSE
    ...
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_employeer_1' and hp.provider_id=provider_3_id) INTO valueExists;
    IF valueExists IS FALSE THEN
...
ELSE
   ...
   SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_municipal_plan_1' and hp.provider_id=provider_4_id) INTO valueExists;
   IF valueExists IS FALSE THEN
...
ELSE
  --HEALTH PLAN DPP
  SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_dpp_1' and hp.provider_id=provider_5_id) INTO valueExists;
  IF valueExists IS FALSE THEN
...
ELSE
  --HEALTH PLAN PDP
  SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_pdp_1' and hp.provider_id=provider_6_id) INTO valueExists;
  IF valueExists IS FALSE THEN
...
ELSE
  ...
  SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_sn_1' and hp.provider_id=provider_7_id) INTO valueExists;
  IF valueExists IS FALSE THEN
      select throw_error('HEALTH PLAN : test_hp_sn_1  MISSING');
  END IF;

    --HEALTH PLAN BCBS
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_bcbs_1' and hp.provider_id=provider_7_id) INTO valueExists;
    IF valueExists IS FALSE THEN
        select throw_error('HEALTH PLAN : test_hp_bcbs_1  MISSING');
    END IF;

    --HEALTH PLAN MEDICARE MA
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_na_1' and hp.provider_id=provider_7_id) INTO valueExists;
    IF valueExists IS FALSE THEN
        select throw_error('HEALTH PLAN : test_hp_na_1  MISSING');
    END IF;

    --HEALTH PLAN COMMERCIAL MEDICAID
    SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_commercial_medicaid_1' and hp.provider_id=provider_7_id) INTO valueExists;
    IF valueExists IS FALSE THEN
...
ELSE
  --HEALTH PLAN PBM
  SELECT EXISTS(SELECT 1 FROM health_plans hp where hp.name='test_hp_pbm_1' and hp.provider_id=provider_8_id) INTO valueExists;
  IF valueExists IS FALSE THEN
