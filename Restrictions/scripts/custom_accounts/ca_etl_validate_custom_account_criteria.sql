CREATE OR REPLACE FUNCTION ca_etl_validate_custom_account_criteria(ca_id integer, provider_names varchar[], health_plan_names varchar[], health_plan_table_name varchar, provider_table_name varchar, plan_type_level boolean) --Data Warehouse
RETURNS boolean AS $$
DECLARE
...
BEGIN
    ...
    LOOP
      ...
      IF plan_type_level IS FALSE THEN
      ...
      IF plan_type_level IS TRUE THEN
