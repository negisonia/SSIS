...
SELECT create_criteria_report(new_report_id,0,criteria_report_type,0,national_geo_type_id,FALSE,FALSE,FALSE,ARRAY[drug_1_id,drug_2_id],ARRAY[]::integer[],'National',ARRAY[]::integer[],existing_custom_account_id,'national',restrictions_array,NULL,NULL,NULL) INTO criteria_report_id;
