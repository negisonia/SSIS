...
SELECT create_criteria_report(new_report_id,0,1,0,4,FALSE,FALSE,FALSE,ARRAY[drug_1_id,drug_2_id],ARRAY[]::integer[],'National',ARRAY[]::integer[],existing_custom_account_id,'national',NULL,NULL,NULL,NULL) INTO criteria_report_id;
