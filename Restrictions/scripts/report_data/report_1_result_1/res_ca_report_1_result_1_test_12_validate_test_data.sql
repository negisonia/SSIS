CREATE OR REPLACE FUNCTION res_ca_report_1_result_1_test_12_validate_test_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
BEGIN
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, commercial_hpt, drug_1, ind1_pa_age_1, expected_provider_notes);
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, commercial_hpt, drug_1, ind1_pa_diagnosis_3, expected_provider_notes);
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, commercial_hpt, drug_1, ind1_pa_clinical_1, expected_provider_notes);
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, hix_hpt, drug_1, ind1_pa_unspecified, expected_provider_notes);
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, hix_hpt, drug_2, ind1_pa_diagnosis_1, expected_provider_notes);
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, commercial_hpt, drug_2, ind1_pa_ql, expected_provider_notes);
  ...
  PERFORM res_rpt_provider_notes_validate_data(criteria_report_id, provider_1, commercial_hpt, drug_1, ind1_pa_ql, expected_provider_notes);
