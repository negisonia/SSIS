CREATE OR REPLACE FUNCTION res_ca_report_1_result_1_test_17_validate_test_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
||']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_diagnosis_1, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_clinical_1, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_age_1, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_diagnosis_3, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);

expected_rpt_geo_output='['||
'{"indication_name":"indication_1","indication_abbre":"Ind1","benefit_name":"Pharmacy","criteria_restriction_name":"QL - criteria_ql_1","criteria_restriction_short_name":"criteria_ql_1","market_name":"Middlesex","drug_name":"drug_1","lives":100,"health_plan_count":1,"provider_count":0,"total_pharmacy_lives":200,"total_medical_lives":0,"total_health_plan_count":2,"total_provider_count":0}'
||']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_ql, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_unspecified, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_past_custom_option_1, drug_1, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_diagnosis_1, drug_2, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_past_custom_option_1, drug_2, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_st_double_co_1_co_2, drug_2, state_market_type, massachusetts_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_unspecified, drug_2, state_market_type, connecticut_market_id, expected_rpt_geo_output);
...
']';
PERFORM res_rpt_geo_drill_state_validate_data(report_id, pharmacy_benefit_type, county_market_type, ind1_pa_ql, drug_2, state_market_type, connecticut_market_id, expected_rpt_geo_output);
