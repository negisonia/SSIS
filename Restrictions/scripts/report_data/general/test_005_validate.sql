CREATE OR REPLACE FUNCTION restrictions_test_005_validate_test_data() --REPORT FRONT END DB
RETURNS boolean AS $$
DECLARE
...
--FORMULARY 10
SELECT EXISTS(SELECT 1 FROM formulary_detail fd WHERE fd.health_plan_id=health_plan_com_inactive and fd.health_plan_name='health_plan_com_inactive' and fd.drug_id=drug_2 and fd.tier_id=tier_3 and fd.preferred_brand_tier_id=3) INTO existsValue;
