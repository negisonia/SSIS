...
SELECT create_criteria_report( report1, userid , criteria_report_type , NULL, state_geo_type_id, NULL, NULL, NULL,drugs_array, health_plan_types_array, 'State', empty_array, NULL,restrictions_array, state_ids, NULL, NULL) INTO fe_report_1;
