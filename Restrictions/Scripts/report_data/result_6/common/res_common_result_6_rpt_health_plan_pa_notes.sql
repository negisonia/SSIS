CREATE OR REPLACE FUNCTION res_common_result_6_rpt_health_plan_pa_notes(report_id INTEGER) -- REPORT FRONT END
RETURNS boolean AS $$
DECLARE
...
--DRUG1 HIX PROVIDER 1
expected_output= '[{"indication_name":"indication_1","dim_criterion_type_id":1,"criterion_name":"Criteria Unspecified","note_position":1,"notes":"Notes"}]';
