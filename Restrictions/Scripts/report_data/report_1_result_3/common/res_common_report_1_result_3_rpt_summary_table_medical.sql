CREATE OR REPLACE FUNCTION res_common_report_1_result_3_rpt_summary_table_medical(report_id INTEGER) -- REPORT FRONT END
RETURNS boolean AS $$
DECLARE
...
expected_medical_summary_table_output= format('',report_id);
