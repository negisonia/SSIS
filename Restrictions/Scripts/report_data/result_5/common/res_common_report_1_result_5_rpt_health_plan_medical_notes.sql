CREATE OR REPLACE FUNCTION res_common_report_1_result_5_rpt_health_plan_medical_notes(report_id INTEGER) -- REPORT FRONT END
RETURNS boolean AS $$
DECLARE
