...
expected_provider_details_table_output= format('[{"provider_id":%1$s,"benefit_name":"Pharmacy","health_plan_type_id":%2$s,"health_plan_type_name":"commercial","lives":100,"drug_name":"drug_2","criteria_restriction_name":"PA - Unspecified - Criteria Unspecified"},'||
'{"provider_id":%1$s,"benefit_name":"Pharmacy","health_plan_type_id":%2$s,"health_plan_type_name":"commercial","lives":100,"drug_name":"drug_2","criteria_restriction_name":"QL - criteria_ql_1"}'||
']',provider_id,commercial_plan_type_id);
