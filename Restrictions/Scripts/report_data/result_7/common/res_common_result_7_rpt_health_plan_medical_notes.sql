CREATE OR REPLACE FUNCTION res_common_result_7_rpt_health_plan_medical_notes(report_id INTEGER) -- REPORT FRONT END
RETURNS boolean AS $$
DECLARE
...
dim_restriction_type_id CONSTANT INTEGER:=2;
drug_1_id INTEGER;
drug_2_id INTEGER;
...
'{"indication_name":"indication_1","dim_criterion_type_id":2,"criterion_name":"ST - Single - drug_3^1","note_position":1,"notes":""}'||
']';
...
--DRUG2 medicare ma
expected_output= '['||
'{"indication_name":"indication_1","dim_criterion_type_id":1,"criterion_name":"criteria_age_1","note_position":1,"notes":"notes drug 2"},'||
'{"indication_name":"indication_1","dim_criterion_type_id":1,"criterion_name":"criteria_lab_3","note_position":1,"notes":"notes drug 2"}'||
']';
PERFORM res_rpt_health_plan_notes_validate_data(report_id, provider_11_id, medicare_ma_plan_type_id, drug_2_id, dim_restriction_type_id, expected_output);
