...
BEGIN
 ...
 PERFORM ca_etl_validate_custom_account_criteria(custom_account_id, ARRAY[]::varchar[], ARRAY['health_plan_comm','health_plan_hix'], health_plan_table_name, provider_table_name, false);
 ...
 PERFORM ca_etl_validate_custom_account_criteria(custom_account_id, ARRAY[]::varchar[], ARRAY['health_plan_comm','health_plan_comm_1','health_plan_empl','health_plan_ma_1'], health_plan_table_name, provider_table_name, false);
