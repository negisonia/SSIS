CREATE OR REPLACE FUNCTION res_validate_custom_criteria_restriction(expected_report_id INTEGER, expected_client_id INTEGER, expected_indication_id INTEGER, expected_indication_name VARCHAR, expected_benefit_name VARCHAR, expected_dim_restriction_type INTEGER, expected_criteria_restriction_name VARCHAR, expected_dim_criterion_type_id INTEGER, expected_restriction_name VARCHAR) --ADMIN DB
RETURNS BOOLEAN AS $$
DECLARE
