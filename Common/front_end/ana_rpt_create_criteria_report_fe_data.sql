CREATE OR REPLACE FUNCTION ana_rpt_create_criteria_report_fe_data(region_names VARCHAR[], health_plan_type_names VARCHAR[], drug_names VARCHAR[], region_type varchar)
RETURNS INTEGER AS $$
DECLARE
