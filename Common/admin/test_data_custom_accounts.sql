...
PERFORM create_custom_account('Custom_Account_4', common_get_table_id_by_name(client, 'client_1'), ARRAY[]::integer[], ARRAY[common_get_table_id_by_name(health_plan, 'health_plan_comm'),common_get_table_id_by_name(health_plan, 'health_plan_comm_1'),common_get_table_id_by_name(health_plan, 'health_plan_comm_2'),common_get_table_id_by_name(health_plan, 'health_plan_ma_1'),common_get_table_id_by_name(health_plan, 'health_plan_ma')],false);
