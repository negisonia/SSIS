CREATE OR REPLACE FUNCTION test_data_custom_accounts() --ADMIN
RETURNS boolean AS $$
DECLARE
...
PERFORM create_custom_account('Custom_Account_4', common_get_table_id_by_name(client, 'client_1'), ARRAY[]::integer[], ARRAY[common_get_table_id_by_name(health_plan, 'health_plan_comm'),common_get_table_id_by_name(health_plan, 'health_plan_comm_1'),common_get_table_id_by_name(health_plan, 'health_plan_empl_1'),common_get_table_id_by_name(health_plan, 'health_plan_ma_1')],false);
PERFORM create_custom_account('Custom_Account_5', common_get_table_id_by_name(client, 'client_1'), ARRAY[]::integer[], ARRAY[common_get_table_id_by_name(health_plan, 'health_plan_comm_1'),common_get_table_id_by_name(health_plan, 'health_plan_ma_1')],false);
