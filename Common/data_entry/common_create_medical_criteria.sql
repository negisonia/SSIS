CREATE OR REPLACE FUNCTION common_create_medical_criteria(new_medical_id INTEGER, new_criteria_id INTEGER, active BOOLEAN) --DATA ENTRY
RETURNS BOOLEAN AS $$
DECLARE
