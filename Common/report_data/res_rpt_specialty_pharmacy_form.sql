...
from (SELECT distinct spf.specialty_pharmacy_id,sp.name,spf.drug_id,spf.url
...
INNER JOIN specialty_pharmacy_forms spf on q.specialty_pharmacy_id=spf.specialty_pharmacy_id  INNER JOIN specialty_pharmacies sp ON sp.id=spf.specialty_pharmacy_id order by spf.specialty_pharmacy_id,spf.drug_id,spf.url )t INTO rpt_specialty_pharmacy_form_output;
