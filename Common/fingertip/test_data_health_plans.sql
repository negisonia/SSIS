...
BEGIN
    ...
    PERFORM common_create_healthplan(commercial_bcbs_hpt_id,TRUE,'health_plan_bcbs',NULL,provider_7_id,'https://health_plan_bcbs/test.pdf');
    PERFORM common_create_healthplan(employer_hpt_id,TRUE,'health_plan_empl',NULL,provider_3_id,'https://health_plan_empl/test.pdf');
    PERFORM common_create_healthplan(medicare_ma_hpt_id,TRUE,'health_plan_ma',NULL,provider_7_id,'https://health_plan_ma/test.pdf');
    PERFORM common_create_healthplan(medicare_sn_hpt_id,TRUE,'health_plan_sn',NULL,provider_7_id,'https://health_plan_sn/test.pdf');
    PERFORM common_create_healthplan(medicare_pdp_hpt_id,TRUE,'health_plan_pdp',NULL,provider_6_id,'https://health_plan_pdp/test.pdf');
    PERFORM common_create_healthplan(state_medicare_hpt_id,TRUE,'health_plan_state',NULL,provider_9_id,'https://health_plan_state/test.pdf');
    PERFORM common_create_healthplan(dpp_hpt_id,TRUE,'health_plan_dpp',NULL,provider_5_id,'https://health_plan_dpp/test.pdf');
    PERFORM common_create_healthplan(commercial_medicaid_hpt_id,TRUE,'health_plan_com_med',NULL,provider_7_id,'https://health_plan_com_med/test.pdf');
    PERFORM common_create_healthplan(union_hpt_id,TRUE,'health_plan_union',NULL,provider_2_id,'https://health_plan_union/test.pdf');
    PERFORM common_create_healthplan(municipal_plan_hpt_id,TRUE,'health_plan_mun',NULL,provider_4_id,null);
