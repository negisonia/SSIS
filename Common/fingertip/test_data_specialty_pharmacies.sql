...
--RETRIEVE DRUGS
  ...
  SELECT common_get_table_id_by_name(drug, 'drug_3') INTO drug_3_id;
...
--RETRIEVE PLANS
  ...
  -- special_pharmacy_4
  SELECT common_create_pbm_specialty_pharmacy('special_pharmacy_4',TRUE) INTO specialty_pharmacy_id;
    -- Insert PBM Speciatly Pharmacy Drugs
    PERFORM common_create_pbm_specialty_pharmacy_drugs(specialty_pharmacy_id, health_plan_empl_1, drug_3_id);
    -- Insert PBM Specialty Pharmacy Specialization
    PERFORM common_create_pbm_specialty_pharmacy_specialization(specialty_pharmacy_id, 'Hepatitis, Anemia' ,TRUE);
    -- Insert PBM Specialty Pharmacy Drug
    PERFORM common_create_pbm_specialty_pharmacy_drug_enrollment_urls(specialty_pharmacy_id, drug_3_id, 'http://www.special_pharmacy_4.com/drug_3SPEForm.pdf');
    -- Insert PBM Health Plan Pharmacy
    PERFORM common_create_pbm_healthplan_pharmacy(specialty_pharmacy_id, health_plan_empl_1, TRUE);

  -- special_pharmacy_5
  SELECT common_create_pbm_specialty_pharmacy('special_pharmacy_5',TRUE) INTO specialty_pharmacy_id;
    -- Insert PBM Speciatly Pharmacy Drugs
    PERFORM common_create_pbm_specialty_pharmacy_drugs(specialty_pharmacy_id, health_plan_ma_1, drug_1_id);
    -- Insert PBM Specialty Pharmacy Specialization
    PERFORM common_create_pbm_specialty_pharmacy_specialization(specialty_pharmacy_id, 'Hepatitis, Anemia' ,TRUE);
    -- Insert PBM Specialty Pharmacy Drug
    PERFORM common_create_pbm_specialty_pharmacy_drug_enrollment_urls(specialty_pharmacy_id, drug_1_id, 'http://www.special_pharmacy_5.com/drug_1SPEForm.pdf');
    -- Insert PBM Health Plan Pharmacy
    PERFORM common_create_pbm_healthplan_pharmacy(specialty_pharmacy_id, health_plan_ma_1, TRUE);
