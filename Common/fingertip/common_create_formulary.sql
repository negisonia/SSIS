CREATE OR REPLACE FUNCTION common_create_formulary(is_active BOOLEAN, ppd_active BOOLEAN, preferred_brand_tier_id INTEGER) --FF_NEW DB
RETURNS INTEGER AS $$
DECLARE
...
BEGIN
    ...
    VALUES (CASE when is_active IS NULL THEN TRUE ELSE is_active END , NULL, NULL, NULL, 
            ...
            current_timestamp, current_timestamp, 0, preferred_brand_tier_id) RETURNING id INTO formulary_id;
