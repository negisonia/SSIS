...
SELECT calculate_report_value('sum_copay_lives', get_report_name_call('rpt_coverage_tier_provider', ARRAY[criteria_report_id,current_month_int]),'drug_name=''DRUG_001'' AND provider_name=''TEST_PROVIDER_002''') INTO actual_value;
expected_value = 500;
