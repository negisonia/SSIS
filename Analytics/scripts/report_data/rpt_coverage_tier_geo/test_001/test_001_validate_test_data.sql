...
SELECT calculate_report_value('total_lives', get_report_name_call('rpt_coverage_tier_geo', ARRAY[criteria_report_id,current_month_int]),'market_name=''STATE_002''') INTO actual_value;
expected_value = 410;
...
SELECT calculate_report_value('total_lives', get_report_name_call('rpt_coverage_tier_geo', ARRAY[criteria_report_id,current_month_int]),'market_name=''STATE_003''') INTO actual_value;
expected_value = 201;
