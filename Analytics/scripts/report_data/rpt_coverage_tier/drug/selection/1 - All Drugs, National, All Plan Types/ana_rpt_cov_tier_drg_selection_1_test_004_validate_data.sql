...
expected_value = '[{"drug_name":"' || drug_name || '","dim_tier_name":"' || dim_tier_name || '","is_tier_preferred":' || is_tier_preferred || ',"dim_tier_id":4,"dim_tier_type_id":1,"avg_copay":30.00,"lis_lives":0,"total_lis_lives":0,"lives":150,"total_lives":1341,"health_plan_count":1,"total_health_plan_count":20}]';
