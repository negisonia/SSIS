...
SELECT calculate_report_value('total_health_plan_count', get_report_name_call('rpt_coverage_tier_drug', ARRAY[criteria_report_id,current_month_int]),'dim_tier_name=''Tier 1'' OR dim_tier_name=''Tier 2''') INTO actual_value;
