CREATE OR REPLACE FUNCTION ana_rpt_cov_restr_drg_selection_1_test_001_validate_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
PERFORM ana_rpt_cov_restr_drg_selection_1_test_01_02_validate_data(expected_value,'001', drug_name, qualifier_name);
