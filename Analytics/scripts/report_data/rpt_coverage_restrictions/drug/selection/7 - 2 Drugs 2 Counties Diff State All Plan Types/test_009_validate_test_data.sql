CREATE OR REPLACE FUNCTION ana_rpt_cov_restr_drug_selection_7_test_009_validate_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
PERFORM ana_rpt_cov_restr_drg_selection_7_test_01_10_validate_data(expected_value,'009', drug, qualifier);
