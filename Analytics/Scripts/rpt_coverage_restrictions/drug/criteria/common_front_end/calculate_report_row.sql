CREATE OR REPLACE FUNCTION ana_rpt_coverage_restrictions_drug_calculate_report_row(expected_value varchar, test_number varchar, drug_name varchar, qualifier_name varchar, fe_data_function varchar) --FRONT END
RETURNS boolean AS $$
DECLARE
