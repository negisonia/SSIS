CREATE OR REPLACE FUNCTION ana_rpt_cov_restr_drug_selection_1_test_002_validate_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
PERFORM ana_rpt_cov_restr_drg_selection_1_test_01_21_validate_data(expected_value,'002', drug, qualifier);
