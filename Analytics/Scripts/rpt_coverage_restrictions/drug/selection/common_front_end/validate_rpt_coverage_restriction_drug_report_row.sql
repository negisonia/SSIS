...
PERFORM validate_comparison_values_varchar(actual_value, expected_value,'ana_rpt_coverage_restrictions_drug_test_'|| test_number ||'_validate_data-error: EXPECTED FOR drug_name ' || drug_name || ' and qualifier_name ' || qualifier_name ||' TO BE ');
