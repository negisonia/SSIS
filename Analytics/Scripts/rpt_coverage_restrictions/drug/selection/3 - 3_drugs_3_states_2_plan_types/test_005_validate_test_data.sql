CREATE OR REPLACE FUNCTION ana_rpt_cov_restr_drug_selection_3_test_005_validate_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
PERFORM ana_rpt_cov_restr_drg_selection_3_test_01_14_validate_data(expected_value,'005', drug, qualifier);
