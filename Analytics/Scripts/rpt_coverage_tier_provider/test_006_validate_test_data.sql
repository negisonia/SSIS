...
SELECT calculate_report_value('primary_dim_tier_id_name_health_plans_count', get_report_name_call('rpt_coverage_tier_provider', ARRAY[criteria_report_id,current_month_int]),'drug_name=''DRUG_001'' AND provider_name=''TEST_PROVIDER_002''') INTO actual_value;
