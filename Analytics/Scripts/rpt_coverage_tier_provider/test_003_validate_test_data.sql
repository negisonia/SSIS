...
PERFORM validate_comparison_values(actual_value, expected_value,'ana_rpt_coverage_tier_provider_test_003_validate_data-error: EXPECTED primary_dim_tier_id_lives FOR DRUG_001 AND TEST_PROVIDER_002 TO BE ');
...
PERFORM validate_comparison_values(actual_value, expected_value,'ana_rpt_coverage_tier_provider_test_003_validate_data-error: EXPECTED primary_dim_tier_id_lives FOR DRUG_003 AND TEST_PROVIDER_002 TO BE ');
