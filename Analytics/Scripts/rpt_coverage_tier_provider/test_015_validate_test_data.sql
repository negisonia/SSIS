CREATE OR REPLACE FUNCTION ana_rpt_coverage_tier_provider_test_015_validate_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
PERFORM validate_comparison_values(actual_value, expected_value,'ana_rpt_coverage_tier_provider_test_015_validate_data-error: EXPECTED primary_health_plan_count FOR DRUG_003 AND TEST_PROVIDER_002 TO BE ');
