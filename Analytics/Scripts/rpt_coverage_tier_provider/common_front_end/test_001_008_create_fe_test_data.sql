...
SELECT create_criteria_report(0,0,0,0,2,FALSE,FALSE,FALSE,ARRAY[drug_001_id,drug_003_id],ARRAY[health_plan_type_001_id],'State',ARRAY[state_001_id,state_002_id],NULL,NULL) INTO criteria_report_id;
