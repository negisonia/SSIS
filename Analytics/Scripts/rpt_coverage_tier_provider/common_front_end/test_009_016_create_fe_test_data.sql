...
SELECT create_criteria_report(NULL,0,NULL,0,2,FALSE,FALSE,FALSE,ARRAY[drug_002_id,drug_003_id],ARRAY[health_plan_type_002_id],'State',ARRAY[state_001_id,state_002_id],NULL,NULL,NULL,NULL,NULL,NULL) INTO criteria_report_id;
