CREATE OR REPLACE FUNCTION ana_rpt_cov_restr_drug_selection_1_test_004_validate_data() --FRONT END
RETURNS boolean AS $$
DECLARE
...
PERFORM ana_rpt_cov_restr_drg_selection_1_test_01_21_validate_data(expected_value,'004', drug, qualifier);
