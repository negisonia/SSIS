...
expected_value =  format('[{"drug_name":"%s","dim_tier_name":"%s","is_tier_preferred":%s,"dim_tier_id":1,"dim_tier_type_id":1,"avg_copay":null,"lis_lives":0,"total_lis_lives":0,"lives":100,"total_lives":250,"health_plan_count":1,"total_health_plan_count":3}]', drug_name, dim_tier_name, is_tier_preferred);
