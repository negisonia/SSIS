...
expected_value =  format('[{"drug_name":"%s","dim_tier_name":"%s","is_tier_preferred":%s,"dim_tier_id":2,"dim_tier_type_id":1,"avg_copay":20.00,"lis_lives":0,"total_lis_lives":0,"lives":170,"total_lives":480,"health_plan_count":2,"total_health_plan_count":6}]', drug_name, dim_tier_name, is_tier_preferred);
