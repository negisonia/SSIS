CREATE OR REPLACE FUNCTION ana_rpt_cov_tier_drg_selection_7_test_01_05_validate_data(expected_value varchar, test_number varchar, drug_name varchar, dim_tier_name varchar, is_tier_preferred boolean)
RETURNS INTEGER AS $$
DECLARE
