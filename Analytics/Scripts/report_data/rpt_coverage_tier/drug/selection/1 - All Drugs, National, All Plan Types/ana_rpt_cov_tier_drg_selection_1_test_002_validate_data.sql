...
expected_value =  format('[{"drug_name":"%s","dim_tier_name":"%s","is_tier_preferred":%s,"dim_tier_id":2,"dim_tier_type_id":1,"avg_copay":10.00,"lis_lives":0,"total_lis_lives":0,"lives":50,"total_lives":1341,"health_plan_count":1,"total_health_plan_count":20}]', drug_name, dim_tier_name, is_tier_preferred);
