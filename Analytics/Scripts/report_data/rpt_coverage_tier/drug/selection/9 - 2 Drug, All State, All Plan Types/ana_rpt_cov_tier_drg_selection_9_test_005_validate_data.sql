...
expected_value = '[{"drug_name":"' || drug_name || '","dim_tier_name":"' || dim_tier_name || '","is_tier_preferred":' || is_tier_preferred || ',"dim_tier_id":1,"dim_tier_type_id":1,"avg_copay":60.00,"lis_lives":0,"total_lis_lives":0,"lives":130,"total_lives":1041,"health_plan_count":3,"total_health_plan_count":16}]';
