CREATE OR REPLACE FUNCTION ana_rpt_cov_tier_drg_selection_3_test_01_11_validate_data(expected_value varchar, test_number varchar, drug_name varchar, dim_tier_name varchar)
RETURNS INTEGER AS $$
DECLARE
