...
SELECT SUM(lives) from rpt_coverage_tier_drug(criteria_report_id,current_month_int) where drug_id = drug_002_id AND is_tier_preferred IS FALSE INTO actual_value;
