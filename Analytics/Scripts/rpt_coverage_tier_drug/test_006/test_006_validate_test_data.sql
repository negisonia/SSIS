...
SELECT SUM(health_plan_count) from rpt_coverage_tier_drug(criteria_report_id,current_month_int) where drug_id = drug_002_id and (dim_tier_id = tier_001_id or dim_tier_id = tier_002_id) AND is_tier_preferred IS FALSE INTO actual_value;
