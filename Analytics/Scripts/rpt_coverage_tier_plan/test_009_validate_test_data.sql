...
-- Validate that each plan has the correct copay
  PERFORM ana_rpt_coverage_tier_plan_test006_validate_copay(60.00, 'HEALTH_PLAN_008');
  PERFORM ana_rpt_coverage_tier_plan_test006_validate_copay(10.00, 'HEALTH_PLAN_009');
  PERFORM ana_rpt_coverage_tier_plan_test006_validate_copay(30.00, 'HEALTH_PLAN_010');
