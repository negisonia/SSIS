...
SELECT id from states where name = 'STATE_003' limit 1 INTO state_003_id;

SELECT create_criteria_report(NULL,0,NULL,0,2,FALSE,FALSE,FALSE,ARRAY[drug_003_id],ARRAY[health_plan_type_001_id,health_plan_type_002_id],'State',ARRAY[state_002_id,state_003_id],NULL,NULL,NULL,NULL,NULL,NULL) INTO criteria_report_id;
