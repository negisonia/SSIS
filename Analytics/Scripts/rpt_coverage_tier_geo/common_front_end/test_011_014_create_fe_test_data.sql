...
SELECT create_criteria_report(NULL,0,NULL,0,3,FALSE,FALSE,FALSE,ARRAY[drug_003_id],ARRAY[health_plan_type_001_id,health_plan_type_002_id],'MetroStatArea',ARRAY[metro_stat_area_001_id],NULL,NULL,NULL,NULL,NULL,NULL) INTO criteria_report_id;
