...
SELECT create_criteria_report(0,0,0,0,4,FALSE,FALSE,FALSE,ARRAY[drug_003_id,drug_004_id,ARRAY[health_plan_type_001_id,health_plan_type_002_id],'State',ARRAY[state_001_id,state_002_id]) INTO criteria_report_id;
add_criteria_report_markets(criteria_report_id, 'MetroStatArea', ARRAY[metro_stat_area_001_id]);
