...
SELECT create_criteria_report(0,0,0,0,3,FALSE,FALSE,FALSE,ARRAY[drug_003_id],ARRAY[health_plan_type_001_id],'County',ARRAY[county_002_id,county_004_id],NULL,NULL) INTO criteria_report_id;
