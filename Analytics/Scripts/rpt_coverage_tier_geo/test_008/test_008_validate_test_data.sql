...
DECLARE
  ...
  expected_value double precision := 255.75;
...
PERFORM validate_comparison_values(actual_value, expected_value,'ana_rpt_coverage_tier_geo_test_008_validate_data-error: EXPECTED TOTAL LIVES FOR TIER 0101, 002 TO BE ');
