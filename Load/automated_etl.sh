...
REPORT_DATA_VALIDATION_SCRIPT_PATHS=(../Restrictions/Scripts/report_data ../Analytics/Scripts/report_data ../Common/report_data ../Common/utils/common_get_table_id_by_name.sql)
